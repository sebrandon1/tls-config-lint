...
A GitHub Action that scans your codebase for TLS configuration anti-patterns and security issues across Go, Python, Node.js/TypeScript, C++, Java, Rust, and C# projects.
...
- **90 TLS Anti-Patterns** — Across 7 languages with severity classification (critical, high, medium, info)
...
| `languages` | `auto` | Comma-separated: `go,python,nodejs,cpp,java,rust,csharp` or `auto` to detect |
...
| Guide | Description |
|-------|-------------|
| [Detected Patterns](docs/patterns.md) | All 90 patterns across 7 languages |
