...
- **89 TLS Anti-Patterns** — Across 6 languages with severity classification (critical, high, medium, info)
...
| Guide | Description |
|-------|-------------|
| [Detected Patterns](docs/patterns.md) | All 89 patterns across 6 languages |
