...
A GitHub Action that scans your codebase for TLS configuration anti-patterns and security issues across Go, Python, Node.js/TypeScript, C++, Java, Rust, and Ruby projects.
...
| `languages` | `auto` | Comma-separated: `go,python,nodejs,cpp,java,rust,ruby` or `auto` to detect |
